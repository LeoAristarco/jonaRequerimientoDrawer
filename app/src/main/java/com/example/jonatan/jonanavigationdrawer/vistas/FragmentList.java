...
import com.example.jonatan.jonanavigationdrawer.modelo.WebServiceFusap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterNoticias.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                interfaceComunicaFragment.enviarNumero(adapterNoticias.getListaDeNoticias().get(recyclerNumeros.getChildAdapterPosition(view)).getDescription());
